...
export const TOKEN_DEV =
  'eyJhbGciOiJIUzI1NiJ9.eyJyb2xlIjoiVVNFUiIsInVzZXJfaWQiOjYsImlhdCI6MTcyMjM0NjgyNywiZXhwIjoxNzMwOTg2ODI3LCJzdWIiOiI2In0.Rf6vNSVDIs3XUEnJDPqq2xhzEWpOoFBoG4OtnYQk_cM';
